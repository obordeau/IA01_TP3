...
(defparameter *rulesbase* '(
    ...
    (((eq STYLE special_tripel)(< PRIX 1.7))(eq BEER "Queue de charrue"))
    (((eq STYLE special_tripel)(>= PRIX 1.7)(eq AROME epices))(eq BEER "Gouden Carolus"))
    (((eq STYLE special_tripel)(>= PRIX 1.7)(eq AROME agrumes))(eq BEER "Tripel Karmeliet"))
